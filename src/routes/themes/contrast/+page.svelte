...
<Panel variant="glass" depth={2} classes="mb-8">
	<Typography el="p" classes="mb-4">
		The UI Kit includes an intelligent contrast adaptation system that automatically adjusts glass effects 
		based on the background luminance. This ensures optimal readability and visual appeal across different backgrounds.
	</Typography>
...
<Panel variant="glass" depth={2} classes="mb-8">
	...
	<pre class="p-4 rounded-lg bg-gray-100 dark:bg-gray-800 mb-4 overflow-x-auto"><code>{`<ContrastAdapter backgroundColor="#1a1a1a">
  <Panel variant="glass">
    Content automatically adapts to dark background
  </Panel>
</ContrastAdapter>`}</code></pre>
	
	<Typography el="h3" classes="mb-3">With Background Image</Typography>
	<pre class="p-4 rounded-lg bg-gray-100 dark:bg-gray-800 mb-4 overflow-x-auto"><code>{`<ContrastAdapter backgroundImage="/path/to/image.jpg">
  <Panel variant="glass">
	...
	<pre class="p-4 rounded-lg bg-gray-100 dark:bg-gray-800 mb-4 overflow-x-auto"><code>{`<ContrastAdapter autoDetect>
  <Panel variant="glass">
...
<Panel variant="surface" depth={1}>
	...
	<pre class="p-4 rounded-lg bg-gray-100 dark:bg-gray-800 overflow-x-auto"><code>{`import { 
  getLuminance, 
...
// { '--glass-bg-opacity': '0.08', ... }`}</code></pre>
</Panel>